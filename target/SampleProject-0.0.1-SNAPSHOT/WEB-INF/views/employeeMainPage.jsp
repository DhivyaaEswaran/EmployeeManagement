...
<body>
	<ul>
		...
		<li><b><a href="goToEmployeeForm">ADD EMPLOYEE</a></b></li>
				...
				<c:forEach items="${employee}" var="employee">
					<tr>
						...
						<td><a href="goToEditEmployee?id=${employee.id}"><button>Edit</button></a>
							...
							<a href="goToAddressForm?id=${employee.id}"><button>Add
									address</button></a> <a href="viewAddress?id=${employee.id}"><button>View
									address</button></a> <a href="displayUnassignedProjects?id=${employee.id}"><button>Assign</button></a>
							<a
