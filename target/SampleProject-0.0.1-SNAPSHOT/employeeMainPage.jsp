			...
			<tbody>
				<c:forEach items="${employeeList}" var="employee">
					<tr>
						...
						<td><a
							href="goToEditEmployee&id=<c:out value='${employee.id}'/>"><button>Edit</button></a>
							<a
							href="/deleteEmployee/${employee.id}"><button>Delete</button></a>
							<a href="/addressForm/${employee.id}"><button>Add address</button></a>
							 <a
							href="viewAddress&id=<c:out value='${employee.id}'/>"><button>View
									address</button></a> <a
