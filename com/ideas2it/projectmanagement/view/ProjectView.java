...
public class ProjectView {
    ...
    public void createProject() {        
        ...
        projectController.createProject(id, name,
    ...
    public void assignEmployee() {                       
        ...
        List<List<Integer>> employeeIdForAssign   
                = projectController.checkIdForAssignAndUnassign(id, employeeIdList); 

        if (employeeIdForAssign.get(1).isEmpty()) { 
            System.out.println("Employee already assigned");
        } else {       
            projectController.assignEmployee(id, employeeIdForAssign.get(1));
    ...
    public void unassignEmployee() {
       ...
       if (employeeIdForUnassign.get(0).isEmpty()) {
           ...
           projectController.unassignEmployee(id, employeeIdForUnassign.get(0));
           System.out.println("\nValues have been unassigned");
       }
    }

    /**
     * Here we display assigned employee
     */
    ...
    public void deleteProject() {
        ...
        System.out.println("\nProject details have been deleted");
    }
    ...
    public void updateProject() {
        ...
        Date endDate = getEndDate();
        String manager = getManager();
        projectController.updateProject(id, name,
                startDate, endDate, manager);
    ...
    public void displayIndividualProject() {
        int id = getId();
        System.out.println(projectController.getIndividualProject(id));
    }
}