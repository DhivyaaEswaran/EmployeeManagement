...
public class EmployeeController {
    ...
    public void createEmployee(int id, String name, double salary, 
        ...
        employeeService.createEmployee(id, name, salary, 
    ...
    public void createAddress(int id, String doorNumber, String streetName, 
        ...
        employeeService.createAddress(id, doorNumber, streetName, 
     ...
     * @param pinCode - pinCode
     */
    public void updateAddress(int employeeId, int addressId, String doorNumber, 
            String streetName, String district, String state,
            String country, int pinCode) {
        employeeService.updateAddress(employeeId, addressId, doorNumber, 
    ...
    public List<String> getIndividualEmployeeAddress(int id) {
        return employeeService.getIndividualEmployeeAddress(id);
    }
