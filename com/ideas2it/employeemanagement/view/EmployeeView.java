...
public class EmployeeView {
    ...
    public void createEmployee() {
        ...
        createAddress();        
        employeeController.createEmployee(id, name, 
    ...
    public void createAddress() {  
        ...
        for (int index = 0; index < count; index++) { 
            ...
            employeeController.createAddress(id, doorNumber, 
    ...
    public void deleteAddress() {
        ...
        employeeController.deleteAddress(id);
    ...
    public void updateAddress() {
        ...
        employeeController.updateAddress(employeeId, addressId, doorNumber, 
                streetName, district, state, country, pinCode);         
    ...
    public void chooseDisplayOption() {              
        String printStatement = ("\nYOU ARE HERE TO SELECT AN OPTION FOR DISPLAY OPTION"
                ...
                + "\n3.DISPLAY INDIVIDUAL EMPLOYEE ADDRESS"
                + "\n4.DISPLAY ASSIGNED PROJECT"
                + "\n5.EXIT");                
        System.out.println(printStatement);
        int userOption = scanner.nextInt();
        ...
        switch (userOption) {
            ...
            case 2:  displayIndividualEmployee();
                     break;
            case 3:  displayIndividualEmployeeAddress();
                     break;
            case 4:  displayAssignedProject();
                     break;
     ...
     */
    public void displayIndividualEmployeeAddress() {
        int id = getEmployeeId();        
        List<String> addressDetails = employeeController.getIndividualEmployeeAddress(id); 
